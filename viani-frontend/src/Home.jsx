...
import userIcon from "./assets/Pessoa.svg";  
      ...
      <header>
        <div className="header-inner">
          ...
          <div className="header-right">
            <button className="icon-btn"><img src={lupaIcon} alt="Lupa"/></button>
            <button className="icon-btn"><img src={userIcon} alt="Usuário"/></button>
